        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('questionOptions.update', $questionOption) }}">
                            @csrf
                            @method('PUT')
                            {{ Form::hidden('question_id', $questionOption->question->id) }}
                            <div class="form-group row">
                                <label for="option" class="col-sm-4 col-form-label text-md-right">Opción</label>

                                <div class="col-md-6">
                                    <input id="option" type="text" class="form-control{{ $errors->has('option') ? ' is-invalid' : '' }}" name="option" value="{{ $questionOption->option }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="question_id"
                                            ...
                                            required
                                            disabled>
                                        <option value="{{ $questionOption->question->id }}">{{ $questionOption->question->question }}</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="correct"
                                            ...
                                            value="{{ old('correct') }}"
                                            required>
                                        <option value="0" {{ $questionOption->correct==0 ? 'selected' : ' ' }}>incorrecta</option>
                                        <option value="1" {{ $questionOption->correct==1 ? 'selected' : ' ' }}>correcta</option>
                                    </select>
