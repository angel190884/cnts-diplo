                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 text-left">
                                Alumnos inscritos.( <strong>{{ $users->total() }} resultados</strong> )
                            </div>
                            <div class="col-sm-12 col-md-12 text-left">
                                {{ Form::open(['route' => 'student.index', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                    ...
                    <div class="card-body">
                        <div>
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tr>
                                    <th colspan="13">LISTA DE ALUMNOS</th>
                                </tr>
                                <tr>
                                    <th scope="col">#ID</th>
